  ...
  return (
    <div className={`page${isMobile ? " mobile" : ""}`}>
      ...
      <section className="header">
        <h1>Specjalista ds. Transportu i Logistyki</h1>
      ...
      <div className="specialist-content">
        <section className="specialistsTasks">
          <div className="sTask">
            <img src="Addchart.png" alt="strategia" />
            <span>
              Zapewnienie zgodności operacji logistycznych z obowiązującymi
          ...
          <div className="sTask">
            ...
            <span>
              Przeprowadzanie analiz kosztów produkcji oraz wdrażanie działań
              mających na celu ich redukcję.{" "}
            </span>
          </div>
          <div className="sTask">
            <img src="supplyChain.png" alt="analiza" />
            <span>
              Koordynowanie działań związanych z transportem, magazynowaniem i
...
export default LogisticSpecialist;
