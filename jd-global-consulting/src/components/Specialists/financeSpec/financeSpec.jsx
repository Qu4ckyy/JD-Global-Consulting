    ...
    <div className={`page${isMobile ? " mobile" : ""}`}>
      ...
      <div className="specialist-content">
        <section className="specialistsTasks">
          <div className="sTask">
            <img src="Group.png" alt="strategia" />
            <span>
              Przygotowywanie prognoz finansowych oraz nadzór nad budżetami
              operacyjnymi i inwestycyjnymi.{" "}
            </span>
          </div>
          <div className="sTask">
            <img src="euro2.png" alt="kalendarz" />
            <span>
              Restrukturyzacja zadłużenia oraz pozyskiwanie dofinansowania z
              Funduszy Unijnych.{" "}
            </span>
          </div>
          <div className="sTask">
            <img src="document.png" alt="analiza" />
            <span>
              Doradztwo w zakresie dokumentacji finansowej, optymalizacji
              podatkowej oraz zarządzania płatnościami i obsługi
              kadrowo-płacowej.
            </span>
          </div>
        </section>
...
export default FinanceSpecialist;
